    ...
    if (this.state.query === '') {
      return (
        <div>
          ...
          <PubItemGroup year={'2016'} pubdata={publicationsdata_2016} />

          <PubItemGroup year={'2015'} pubdata={publicationsdata_2015} />

          <PubItemGroup year={'2014'} pubdata={publicationsdata_2014} />
...
export const publicationsQuery = graphql`
  query publicationsQuery {
    allPublications: allPublicationsCsv(sort: { fields: [index], order: ASC }) {
      edges {
        node {
          index
          authors
